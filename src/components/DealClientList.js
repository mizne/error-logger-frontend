...
import { fetchAll, fetchFilters, remove } from '../actions/deal-client.action'
import {
  getDealClientItems,
  getDealClientLoading,
  getDealClientPagination,
  getDealClientModuleFilters
} from '../reducers'
...
class DealClientList extends Component {
  state = {
    rowKey: '_id',
    selectedRowKeys: [],
    filter: {
...
const mapStateToProps = state => ({
  items: getDealClientItems(state),
  loading: getDealClientLoading(state),
  pagination: getDealClientPagination(state),
  moduleFilters: getDealClientModuleFilters(state)
})

export default connect(mapStateToProps)(DealClientList)
